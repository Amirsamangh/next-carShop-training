...
const cars = [
    ...
    { id: 2, name: 'chevrolet camaro', price: '$66,575' },
    ...
    { id: 8, name: 'BMW  x series-6', price: '$75,800' },
]
            ...
            <div className="container">
                ...
                <div className="featured-cars-content">
                    <div className="row">
                        {
                            cars.map(c => (
                                <div key={c.id} className="col-lg-3 col-md-4 col-sm-6 " onClick={()=>{router.push(`/featuredCars/${c.id}`)}}>
                                    <div className="single-featured-cars">
                                        <div className="featured-img-box pointer">
